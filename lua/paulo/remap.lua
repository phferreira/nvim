...
vim.keymap.set('n', '<leader>fa' , ':call FlutterAnalyze()<cr>')
vim.keymap.set('n', '<leader>ft' , ':call FlutterTest()<cr>')
vim.keymap.set('n', '<leader>fct', ':call FlutterCreateTest()<cr>')
vim.keymap.set('n', '<leader>fta', ':call FlutterTestAll()<cr>')
